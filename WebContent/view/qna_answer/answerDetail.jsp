		...
		<div class="outer">
			...
			<div class="tableArea">
				<table class="type05">
					...
					<tr>
						...
						<td height="200px">
							...
							<%-- <textarea class="txt" readonly id="reviewInput" cols="30" style="height: 190px;"><%=q.getqAnswer() %></textarea> --%>
						</td>
					</tr>
				...
				<div class=btn-area>
					...
					<input type="button" value="답변 등록하기" class="btn-updateRequest btn"
						onclick="location.href = 'upView.qna?qno=<%= q.getqNum() %>'">
				</div>
				<% } %>
			</div>
