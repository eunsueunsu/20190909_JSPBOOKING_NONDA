    ...
    function goSubmit() {
    	...
    	$.ajax({
    		...
    		url : "/Nonda/rInsert.re", 
    				// + "&bno=" + bno
    		data: {star:star, content:content, pcode:pcode},
...
<body onresize="parent.resizeTo(480,780)">
    ...
    <input type="hidden" id="hdPcode" value=<%=r.getPcode() %>>
    
    <header class="head">
        <h1 class="title">
            <span class="title_span">리뷰 작성하기</span>
        </h1>
    </header>
        ...
        <div class="play-info">
            <div class="play-info-area">
               ...
               <div class="play-txt">
                   ...
                   <p class="play-date"><%=r.getRdate() %></p>
               </div>
            </div>
            ...
            <div class="review-area">
                <div class="star-area">
                    ...
                    <div class="star_line">
                        <div class="star">
                        <input type="hidden" id="hdField" name="hdstar">
                ...
                <div class="text-please">
                    ...
                    <div class="txtarea_line">
                        <div class="txtarea_panel">
                            ...
                            <textarea class="txt" id="reviewInput" name="rcontent" placeholder="10자 이상 입력해주세요." cols="30" style="width: 400px; height: 200px;"></textarea>
                        </div>
                    </div>
            ...
            <div class="btn-area">
                ...
                <div class="confirm-area">
                    <button class="confirm-btn" type="submit" onclick="goSubmit()">확인</button>
                </div>
            </div>
            </div>
