...
/**
 * Servlet implementation class QnaListbyIdServlet
 */
@WebServlet("/qListbyId.qna")
public class QnaListbyIdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QnaListbyIdServlet() {
        super();
